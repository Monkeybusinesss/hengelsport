...
if (!isset($_SESSION['row']) OR $user['role_id'] != 2) {
    ...
    $detail = $db->show_detailLocatie($_GET['id']);
        ...
        if (!$error) {
            $db->update_locatie($_POST['naam'], $_GET['id']);
        }else{
        ...
        <hr>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Naam</label>
                    <input type="text" name="naam" value="<?php echo $detail[0]['locatie']; ?>" class="form-control" required/>
                </div>
            </div>
