        ...
        <table class="display table table-striped" id="overzicht">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row['inkoopprijs'];?></td>
                    <td><?php echo $row['verkoopprijs'];?></td>
                    <td><?php echo $row['leverancierNaam'];?></td>
                    <td>
                        <a class="btn btn-primary mr-2 btn-sm" href="edit_voorraad.php?id=<?php echo $row['ID']; ?>">Edit</a>
                    </td>      
                    <td>
