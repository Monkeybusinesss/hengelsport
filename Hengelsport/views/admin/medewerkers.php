...
if (!isset($_SESSION['row']) OR $user['role_id'] != 2) {
    ...
    $personen = new DB('localhost','root','','hengelsport','utf8mb4');

    $personen->show_medewerkers();

    if (isset($_POST['destroy'])) {
        $personen->destroy_medewerker($_POST['medewerkerID']);
    }
}
?>
<!DOCTYPE html>
   ...
   <div class="logo">
    ...
    <main role="main" class="container">
        <div class="pull-right">
            <a class="btn btn-success mb-3" href="add_medewerker.php">+ Medewerker Toevoegen</a>
        </div>
        <table class="display table table-striped" id="overzicht">
            ...
            <tbody>
                <?php foreach ($personen->rows as $row): ?>
                <tr>
                    ...
                    ?></td> 
                    <td>
                        <a class="btn btn-primary mr-2 btn-sm" href="edit_medewerker.php?id=<?php echo $row['ID']; ?>">Edit</a>
                    </td>      
                    <td>
                        <form action="" method="post">
                            <input type="hidden" name="medewerkerID" value="<?php echo $row['ID']; ?>">
