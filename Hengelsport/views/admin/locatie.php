...
if (!isset($_SESSION['row']) OR $user['role_id'] != 2) {
    ...
    if (isset($_POST['destroy'])) {
        $db->destroy_locatie($_POST['locatieID']);
    }
}
?>
<!DOCTYPE html>
...
<body>
   <div class="logo">
     ...
     <div id="mySidebar" class="sidebar">
        ...
        <a href="locatie.php" class="active">locatie</a>
    ...
    <?php if (isset($db->message)) {
        ...
        <div class="pull-right">
            <a class="btn btn-success mb-3" href="add_locatie.php">+ Locatie Toevoegen</a>
        </div>
        <table class="display table table-striped" id="overzicht">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary mr-2 btn-sm" href="edit_locatie.php?id=<?php echo  $row['ID']; ?>">Edit</a>
                    </td>      
                    <td>
                        <form action="" method="post">
                            <input type="hidden" name="locatieID" value="<?php echo $row['ID']; ?>">
